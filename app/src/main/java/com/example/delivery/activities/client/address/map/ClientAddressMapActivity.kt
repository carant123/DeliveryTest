...
import kotlinx.android.synthetic.main.activity_client_address_map.*
...
class ClientAddressMapActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        bt_accept?.setOnClickListener { goToCreateAddress() }
    ...
    private fun getLastLocation() {
        if(checkPermission()) {
            if(isLocationEnabled()) {
                ...
                Toast.makeText(this, "Habilitar la localizacion", Toast.LENGTH_LONG).show()
